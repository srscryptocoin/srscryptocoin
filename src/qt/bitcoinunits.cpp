...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("SRS");
    case mBTC: return QString("mSRS");
    case uBTC: return QString::fromUtf8("μSRS");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("SrsCoins"));
    case mBTC: return QString(QObject::tr("Milli-SrsCoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-SrsCoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
